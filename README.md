...
3. Run the following command on the Raspberry Pi: `curl -sSL https://raw.githubusercontent.com/DIYCharles/little-backup-box/main/install-little-backup-box.sh | bash`
...
To uninstall Little Backup Box, run the following command:
    ...
    curl -sSL https://raw.githubusercontent.com/DIYCharles/little-backup-box/main/uninstall-little-backup-box.sh | bash
